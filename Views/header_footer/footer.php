                            ...
                            <div class="footer-text">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p>hungdeptrai@gmail.com</p>
                                        <p>QGToppo@gmail.com</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 r-margin-top wide-mobile">
                        <div class="single-text">
                            ...
                            <div class="clearfix instagram">
                                <ul>
                                    <li><a href="#"><img src="public/img/footer/fb.jpg" alt="Instagram" /></a></li>
                                    <li><a href="#"><img src="public/img/footer/yt.jpg" alt="Instagram" /></a></li>
                                    <li><a href="#"><img src="public/img/footer/tt.jpg" alt="Instagram" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>&copy; QHNFreshfood 2022. All Rights Reserved.</p>
                </div>
