            ...
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            <li class="active"><a data-toggle="tab" href="#arrival">Thịt và cá nhập khẩu <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#popular">Rau củ quả sạch <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#best">Sốt và gia vị</a></li>
                        </ul>
                    </div>
                </div>
            </div>
